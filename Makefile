#############################################################################
# Makefile for building: build/bin/gpuna_mini_proj
# Generated by qmake (3.1) (Qt 5.15.7)
# Project:  gpuna_mini_proj.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile gpuna_mini_proj.pro
#############################################################################
...
INCPATH       = -I. -I. -I/opt/cuda/include -I/usr/include/opencv4 -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -Ibuild -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = gpuna_mini_proj1.0.0
DISTDIR = /home/purg3me/Projects/gpuna_mini_proj/build/gpuna_mini_proj1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -pipe -O2 -flto=12 -fno-fat-lto-objects -fuse-linker-plugin -fPIC
LIBS          = $(SUBLIBS) -L/opt/cuda/lib -L/opt/cuda/lib64 -lcudart -lcuda -lopencv_core -lopencv_videoio -lopencv_highgui -lopencv_imgproc -lopencv_imgcodecs /usr/lib/libQt5Widgets.so /usr/lib/libQt5Gui.so /usr/lib/libQt5Core.so -lGL -lpthread   
AR            = gcc-ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = main.cpp build/moc_mainwindow.cpp
OBJECTS       = build/cuda_inverter_cuda.o \
		build/main.o \
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		gpuna_mini_proj.pro mainwindow.h \
		cuda.h main.cpp
QMAKE_TARGET  = gpuna_mini_proj
DESTDIR       = build/bin/
TARGET        = build/bin/gpuna_mini_proj


first: all
####### Build rules

build/bin/gpuna_mini_proj:  $(OBJECTS)  
	@test -d build/bin/ || mkdir -p build/bin/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: gpuna_mini_proj.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		gpuna_mini_proj.pro
	$(QMAKE) -o Makefile gpuna_mini_proj.pro
...
all: Makefile build/bin/gpuna_mini_proj
...
distdir: FORCE
	...
	$(COPY_FILE) --parents cuda_inverter.cu $(DISTDIR)/
	$(COPY_FILE) --parents /usr/lib/qt/mkspecs/features/data/dummy.cpp $(DISTDIR)/
	$(COPY_FILE) --parents mainwindow.h cuda.h $(DISTDIR)/
...
compiler_cuda_d_make_all: build/cuda_inverter_cuda.o
compiler_cuda_d_clean:
	-$(DEL_FILE) build/cuda_inverter_cuda.o
build/cuda_inverter_cuda.o: cuda_inverter.cu \
		cuda.h \
	...
	/opt/cuda/bin/nvcc -I"." -I"/opt/cuda/include" -I"/usr/include/opencv4" -c -o build/cuda_inverter_cuda.o cuda_inverter.cu
...
build/moc_mainwindow.cpp: mainwindow.h \
		build/moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/purg3me/Projects/gpuna_mini_proj/build/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/purg3me/Projects/gpuna_mini_proj -I/home/purg3me/Projects/gpuna_mini_proj -I/opt/cuda/include -I/usr/include/opencv4 -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/12.2.0 -I/usr/include/c++/12.2.0/x86_64-pc-linux-gnu -I/usr/include/c++/12.2.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/12.2.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/12.2.0/include-fixed -I/usr/include mainwindow.h -o build/moc_mainwindow.cpp
...
compiler_lex_clean:
compiler_clean: compiler_cuda_d_clean compiler_moc_predefs_clean compiler_moc_header_clean 

####### Compile

build/main.o: main.cpp cuda.h \
		mainwindow.cpp \
		mainwindow.h
